/// TODO: todo8 - Create class MockNumberTriviaRepository
...
void main() {
  ...
  test('should get trivia for the number from the repositories', () async {
      /// TODO: failed with any
      // arrange
      when(mockNumberTriviaRepository.getConcreteNumberTrivia(any as int)).thenAnswer((_) async => const Right(tNumberTrivia));
      // act
